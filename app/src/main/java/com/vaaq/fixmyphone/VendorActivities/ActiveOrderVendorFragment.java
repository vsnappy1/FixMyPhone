 ...
 * Use the {@link ActiveOrderVendorFragment#newInstance} factory method to
 * create an instance of getContext() fragment.
 */
public class ActiveOrderVendorFragment extends Fragment {
    ...
    public ActiveOrderVendorFragment() {
     ...
     * @return A new instance of fragment ActiveOrderVendorFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ActiveOrderVendorFragment newInstance(String param1, String param2) {
        ActiveOrderVendorFragment fragment = new ActiveOrderVendorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_active_order_vendor, container, false);
        ...
        recyclerView = view.findViewById(R.id.recyclerViewActiveOrderVendor);
    ...
    void getActiveOrderKeys() {
        ...
        dialogHelper.showProgressDialog("Fetching Active Orders");
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (activeOrderIds.size() > 0) {
                    ...
                    Toast.makeText(getContext(), "No Active Order", Toast.LENGTH_SHORT).show();
                }
