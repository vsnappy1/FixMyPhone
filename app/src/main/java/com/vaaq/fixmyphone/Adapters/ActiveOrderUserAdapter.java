...
public class ActiveOrderUserAdapter extends RecyclerView.Adapter<ActiveOrderUserAdapter.ActiveOrderHolder> {
    ...
    public ActiveOrderUserAdapter(ArrayList<ActiveOrder> list, Context context, Activity activity) {
        this.list = list;
    ...
    public ActiveOrderHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_active_order_user, parent, false);
